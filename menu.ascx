            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-xs-4">
                        <div class="top-number"><p><i class=""></i>  Make your own websites for free...</p></div>
                    </div>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <%
                            ...
                            else
                            {
                             ...
                             %>
                        <li><a runat="server" id="register" href="registration.aspx">Register</a></li> 
                        <li><a runat="server" id="login" href="login.aspx">Login</a></li>                        
                    </ul>
                </div>
            </div><!--/.container-->
        </nav>        
