                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="dist/img/male-user.png" class="user-image" alt="User Image" />
                                    <span class="hidden-xs"><asp:Literal runat="server" ID="ltr_admin"></asp:Literal></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    <li class="user-header">
                                        <img src="dist/img/male-user.png" class="img-circle" alt="User Image" />
                                        <p>
                                            <asp:Literal runat="server" ID="ltr_admin2"></asp:Literal>
                     
                                            <small>Web Creation Inc.</small>
                                        </p>
                                    </li>
                                    <!-- Menu Body -->
                                    <li class="user-body">
